...
public class PrincipalController implements Initializable {
    ...
    @FXML
    private void btnFiltrarOnAction(ActionEvent event) throws Exception {
        carregarContatos(txtFiltro.getText());
    }

    @FXML
    private void btnLimparOnAction(ActionEvent event) throws Exception {
        txtFiltro.clear();
        carregarContatos("");
    }

    public void carregarContatos(String param) throws Exception {
